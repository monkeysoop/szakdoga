...
\begin{figure}[H]
	...
	\caption{Az ábrán a Normál mód SDF hívásainak egy pixelre jutó átlagai láthatóak egy „temple” nevezetű SDF esetében.}
...
Az SSIM érték nem a legjobb apróbb eltérések mérésére jelen esetben így a Debug módnál azt is megmértem, hogy mennyi a nem konvergált pixelek száma összesen.
...
\begin{figure}[H]
	...
	\caption{Az ábrán a Debug mód nem konvergált pixelek számai láthatóak.}
\end{figure}
...
A különbség leginkább feltűnő, ha „Debug” megjelenítést használunk, az alábbi ábrákon az 1920x1080 felbontású „Debug” módszer 4x4 és 8x8-as kúpkövetés futási idejei láthatóak, a felső 3 sor itt nem releváns az ábrákon.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth,keepaspectratio,frame]{benchmarks/benchmarks_1920_1080/avg_render_times_gl_query_debug_1920_1080.png}
	\caption{Az ábrán a Debug mód OpenGL query által mért futási idejei láthatóak 4x4-es kezdeti kúpmérettel.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Az ábrán a Debug mód OpenGL query által mért futási idejei láthatóak 8x8-as kezdeti kúpmérettel.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth,keepaspectratio,frame]{benchmarks/benchmarks_1920_1080/sdf_calls_avg_debug_1920_1080.png}
	\caption{Az ábrán a Debug mód SDF hívásainak egy pixelre jutó átlagai láthatóak 4x4-es kezdeti kúpmérettel.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth,keepaspectratio,frame]{benchmarks/benchmarks_1920_1080/sdf_calls_avg_debug_1920_1080.png}
	\caption{Az ábrán a Debug mód SDF hívásainak egy pixelre jutó átlagai láthatóak 8x8-as kezdeti kúpmérettel.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Az ábrán a Debug mód OpenGL query által mért futási idejei láthatóak 4K felbontás mellett és 4x4-es kezdeti kúpmérettel.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Az ábrán a Debug mód OpenGL query által mért futási idejei láthatóak 4K felbontás mellett és 8x8-as kezdeti kúpmérettel.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Az ábrán a Debug mód SDF hívásainak egy pixelre jutó átlagai láthatóak 4K felbontás mellett és 4x4-es kezdeti kúpmérettel.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth,keepaspectratio,frame]{benchmarks/benchmarks_3840_2160/sdf_calls_avg_debug_3840_2160.png}
	\caption{Az ábrán a Debug mód SDF hívásainak egy pixelre jutó átlagai láthatóak 4K felbontás mellett és 8x8-as kezdeti kúpmérettel.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Az ábrán a Debug mód nem konvergált pixelek számai láthatóak 4K felbontás mellett és 4x4-es kezdeti kúpmérettel}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Az ábrán a Debug mód nem konvergált pixelek számai láthatóak 4K felbontás mellett és 8x8-as kezdeti kúpmérettel}
\end{figure}
