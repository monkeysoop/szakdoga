...
A referenciától való eltérés mérésére SSIM (Structured Similarity Index Measure), értékeket használok, maguk az értékek 0.0 és 1.0 között vannak, minnél magasabb annál nagyobb az egyezés.
...
A különbség leginkább feltünő, ha „Debug” megjelenítést használunk, az alábbi ábrákon az 1920x1080 felbontású „Debug” módszer 4x4 és 8x8-as kúpkövetés futási idejei láthatóak, a felső 3 sor itt nem releváns az ábrákon.
...
A méréseket többnyire a Newton ingája nevezető távolságfüggvényre alapoztam, ami többnyire gömbökből és vékony hasábokból ál, ezért a javított módszer a mérések többségéban lemarad a relaxált és helyenként még a naiv módszerhez képest is. A javított módszer előnye, hogy nagy lapos felületek hatékonyan tud kezelni, de cserébe az algoritmus jóval bonyolultabb, valamint konkáv régiókat (például: egy sarok) is rosszul tud kezelni. A „temple” nevezetű SDF függvény például ponthogy a javított módszernek kedvez ez a mérés: \ref{im:temple_sdf_avg} szerint.
