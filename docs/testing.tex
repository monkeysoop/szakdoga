...
Az iterációk számának a mérése is fontos szerintem, vagyis az SDF függvények hívásainak a száma, kivéve: az ambiens kitakarás, puha árnyékok, normál irány kiszámításához szükségesek kiértékelések számát. Fontos, mivel egyrészt ez egy jó képet ad az algoritmusok hatékonyságáról, másrészt ez egy determinisztikus érték (mérés alatt idő nullára van állítva), ami platformfüggetlen és ismételhető.
