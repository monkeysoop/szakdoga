...
Megemlítendő, hogy az imgui conan csomag nem tartalmazza az SDL2/OpenGL könyvtárakkal való együttműködéshez szükséges úgynevezett „imgui fbindings”-okat, ezeket álltalában git submodul-ként szokták pótolni, de én egy másik utat választottam: a conan csomagjában megtalálhatóak a szükséges fájlok, ezeket én kimásolom (conan-nal) és subproject-ként építem meson-nal manuálisan.
...
\begin{itemize}
	...
	\begin{figure}[H]
    	...
    	\caption{A Newton ingája SDF iteráció számai láthatóak, minnél világosabb annál nagyobb az iteráció szám, ahol fekete = 0 iteráció és fehér = iteráció limit.}
    \end{figure}
