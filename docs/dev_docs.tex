...
\begin{itemize}
	...
	\begin{figure}[H]
    	...
    	\caption{A Newton ingája SDF iterációszámai láthatóak, minél világosabb annál nagyobb az iterációszám, ahol fekete = 0 iteráció és fehér = iteráció limit.}
    \end{figure}
	...
	\begin{figure}[H]
    	...
    	\caption{A Newton ingájának SDF-je látható Debug megjelenítési módban.}
    \end{figure}
