...
\begin{itemize}
	...
	\begin{figure}[H]
    	...
    	\caption{A Newton ingájának SDF-je látható Debug módban.}
    \end{figure}
...
A Normál módban a puha árnyékok kiszámolását ugyanaz az algoritmus végzi, mint amit kiválasztottunk, kúpkövetésnél ez a naiv, relaxált, javított egyike lesz, míg az ambiens kitakarást kizárólag naiv módszer végzi, ahol az iteráció limit egy paraméterezhető fix érték.
