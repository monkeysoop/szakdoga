...
\begin{figure}[H]
	...
	\caption{Az ábrán a program indítás utáni állapotát, egy Newton ingája SDF-et láthatunk a képen.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Az ábrán a beállítások menü megnyitás utáni állapota látható.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth,keepaspectratio]{gui/gui_6.png}
	\caption{Az ábrán a beállítások menü első négy almenüje látható kibontva.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Az ábrán különböző SDF primitívekből álló jelenet látható.}
\end{figure}
...
A következő (ötödik fül) almenüben a használt módszert kiválasztó rádiógombok és a relaxált valamint a javított módszerhez tartozó gömbkövetési paraméterek (a naiv módszerhez külön nincsenek) találhatóak.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth,keepaspectratio]{gui/gui_10.png}
	\caption{Az ábrán az ötödik almenü részlegesen kibontva látható.}
\end{figure}

Az ötödik almenü még a kúpkövetéshez tartozó paramétereket is tartalmazza, ezekkel a kiindulási kúpméret állítható, a köztes epszilon, köztes (kúpkövetés alatti) gömbkövetési módszer (módosított, hogy működjön a kúpkövetéssel) és az azokhoz tartozó paraméterek, valamint a kúpkövetés befejezte után futó gömbkövetési módszer és az azokhoz tartozó paraméterek is.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth,keepaspectratio]{gui/gui_11.png}
	\caption{az ábrán az ötödik almenü, a kúpkövetéshez tartozó beállítások láthatóak.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Az ábrán a hatodik almenü, a tesztelés paraméterei láthatóak.}
\end{figure}
