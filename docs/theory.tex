...
Példaként legyen egy kitalált képernyő, ami 640*480 pixeles és a kezdeti kúpméret legyen 8*8 (ez paraméterezhető), a kúpkövetés ebben az esetben úgy nézne ki, hogy:

\begin{enumerate}
	\item 80*60 szálon a 8*8 pixeles kúpokat követjük
	\item szinkronizáció
	\item 160*120 szálon 4*4 pixeles kúpok a megfelelő 8*8-as kúp eredményéből indítva
	\item szinkronizáció
	\item 320*240 szálon 2*2 pixeles kúpok a 4*4 es eredményeit felhasználva
	\item szinkronizáció
	\item alap/relaxált/javított sugárkövetés pixelenként (640*480 szálon) a megfelelő 2*2-es kúpok eredményeit felhasználva
\end{enumerate}
