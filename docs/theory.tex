...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/sphere_tracing/sphere_tracing_0.png}
...
A megoldandó probléme: egy térbeli téglalap (az implementációban csakis négyzeteket használok, amik egy vagy több pixelből álló „blokkokat” reprezentálnak) kamera szemszögéből kiinduló gúlájának, megtaláljuk a lehető legkisseb az azt körbe ölelő kúpját.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing_3D/cone_tracing_3D_0.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing_3D/cone_tracing_3D_1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing_3D/cone_tracing_3D_2.png}
	\caption{Az ábrán kék körként látható a naiv megoldás.}
\end{figure}

Egy egyszerű trükkel szinte optimális megoldást kaphatunk, lényegében a vetítés utáni hosszabb átló közepét használja a kör/kúp közepének/irányának, ez nem mindig a legoptimálisabb megoldás mivel az átló és a kamerához közelebbi vetített pont által alkotott háromszög lehet hegyesszögű a kamerához közeli pontnál, de bőven elég jó közelítés.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing_3D/cone_tracing_3D_3.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing_3D/cone_tracing_3D_4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth,height=100px]{gui/cone_error_1.png}
    \vspace{5pt}
    \includegraphics[width=0.6\textwidth,height=100px]{gui/cone_error_2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_0.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_4_1.png}
    \vspace{5pt}
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_4_2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_5.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_15.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_6.png}
	\caption{Az ábrán a kúpkövetés 3. iterációja látható.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_7.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_8_1.png}
    \vspace{5pt}
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_8_2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_9.png}
	\caption{Az ábrán a 2 új kúp látható, amelyek a már biztos távolságtól (zöld) fogják folytatni útjaikat.}
\end{figure}

Most csak a felsőbb 2 pixeles kúp mentén fogom részletezni tovább az algoritmust (a valóságban ezek egymástól függetlenül akár párhozamosan is tudnak tovább haladni), ami az eddig megtett távolságtól tud továbbhaladni.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_10.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_11_1.png}
    \vspace{5pt}
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_11_2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_12.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_13_1.png}
    \vspace{5pt}
	\includegraphics[width=0.6\textwidth,height=100px]{geogebra/cone_tracing/cone_tracing_13_2.png}
...
Példaként legyen egy kitalált képernyő, ami 24*48 pixeles és a kezdeti kúpméret legyen 8*8 (ez paraméterezhető), a kúpkövetés ebben az esetben úgy nézne ki, hogy:

\begin{enumerate}
	\item 3*6 szálon a 8*8 pixeles kúpokat követjük
	\item szinkronizáció
	\item 6*12 szálon 4*4 pixeles kúpok a megfelelő 8*8-as kúp eredményéből indítva
	\item szinkronizáció
	\item 12*24 szálon 2*2 pixeles kúpok a 4*4 es eredményeit felhasználva
	\item szinkronizáció
	\item alap/relaxált/javított sugárkövetés pixelenként a megfelelő 2*2-es kúpok eredményeit felhasználva
\end{enumerate}
...
Kis módosítással a relaxált/javított módszert is tudjuk alkalmazni a kúpkövetésre, azaz a lépés mértékét valamilyen értékkel, legyen az konstans/heurisztikus beszorozzuk és ha ez nem jött be akkor csak visszalépünk. Ez meglehetősen jól fog működni, hiszen a kúpok álltalában nagyon keskenyek, mivel a GPU jó kihasználtsága érdekében álltalában nincs értelme 8*8 vagy 16*16 pixeles gúláknál nagyobbakból kiindulni, amik meglehetősen keskeny kúpokat adnak.
