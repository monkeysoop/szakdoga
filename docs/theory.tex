...
Jelen esetben ezt az egy nagy kúpunkat fogjuk megfelezni, így lesz belőle két kisebb kúpunk és a már megtett távolságtól tudjuk folytatni azokat, úgy, hogy a program helyességét megőrizzük.
...
Most csak a felsőbb két pixeles kúp mentén fogom részletezni tovább az algoritmust, ami az eddig megtett távolságtól tud tovább haladni, ezek egymástól függetlenül, párhuzamosan is tudnak tovább haladni. A zöld korong innentől kezdve csakis a felsőbb kúpra fog vonatkozni a jelölésekben.
...
Kis módosítással a relaxált/javított módszert is tudjuk alkalmazni a kúpkövetésre, azaz a lépés mértékét valamilyen értékkel, legyen az konstans/heurisztikus beszorozzuk és ha ez nem jött be akkor csak visszalépünk. Ez meglehetősen jól fog működni, hiszen a kúpok általában nagyon keskenyek, mivel a GPU jó kihasználtsága érdekében általában nincs értelme 8x8 vagy 16x16 pixeles gúláknál nagyobbakból kiindulni, amik meglehetősen keskeny kúpokat adnak.
